...
nnoremap <C-J> <C-W><C-J>       " Use Ctrl-J vs Ctrl-W, J
nnoremap <C-K> <C-W><C-K>       " Use Ctrl-K vs Ctrl-W, K
nnoremap <C-L> <C-W><C-L>       " Use Ctrl-L vs Ctrl-W, L
nnoremap <C-H> <C-W><C-H>       " Use Ctrl-H vs Ctrl-W, H
